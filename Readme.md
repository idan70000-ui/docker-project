...
The application was developed using **Node.js**, **Express.js**, and **MongoDB**, then fully containerized with **Docker** and automated using **GitHub Actions CI/CD** workflows.
